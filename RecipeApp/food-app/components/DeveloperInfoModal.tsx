                ...
                <View className="flex-1 mt-24 bg-white rounded-t-3xl">
                    ...
                    <View className="flex-row justify-between items-center p-4 border-b border-gray-200">
                        <View className="flex-row items-center">
                            <Text className="text-xl font-bold text-gray-800">About the Developers</Text>
                            { Platform.OS === 'web' && <TouchableOpacity
                                onPress={handleDownloadApp}
                                className="ml-4 bg-amber-500 px-4 py-2 rounded-full"
                            >
                                ...
                                <View key={index} className="mb-8 bg-white rounded-xl shadow-sm p-4">
                                    <View className="flex-row items-center mb-4">
                                        ...
                                        <View className="ml-4">
                                            ...
                                            {developer.location && (
                                                <Text className="text-gray-500 text-xs">{developer.location}</Text>
                                            )}
                                            {developer.experience && (
                                                <Text className="text-gray-500 text-xs">{developer.experience} experience</Text>
                                            )}
                                        </View>
                                    </View>
